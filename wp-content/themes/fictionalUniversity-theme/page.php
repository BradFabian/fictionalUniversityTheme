...
<div class="page-banner">
  ...
  <div class="container container--narrow page-section">
    ...
    if($theParent) { ?>
      ...
      <p><a class="metabox__blog-home-link" href="<?php get_permalink($theParent); ?>"><i class="fa fa-home" aria-hidden="true"></i> Back to <?php get_the_title($theParent); ?></a> <span class="metabox__main"><?php the_title(); ?></span></p>
    </div>
    <?php };  ?>
